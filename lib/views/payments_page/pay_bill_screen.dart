            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  children: [
                    PayBillAction(
                        title: 'TV', icon: Icons.tv_off_rounded, action: () {}),
                    PayBillAction(
                        title: 'Internet', icon: Icons.web_rounded, action: () {}),
                    PayBillAction(
                        title: 'Electricity', icon: Icons.lightbulb, action: () {}),
                    PayBillAction(
                        title: 'Betting', icon: Icons.games, action: () {}),
                    PayBillAction(
                        title: 'Transport & Toll', icon: Icons.emoji_transportation, action: () {}),
                  ],
                ),
              ),
            ),
